...
export class Backend implements backendInterface {
    ...
    async bookAppointment(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Time): Promise<bigint> {
    ...
    async getAppointmentsByBarber(arg0: string): Promise<Array<Appointment>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAppointmentsByBarber(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBarbers(): Promise<Array<Barber>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBarbers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
